...
router.get('/getSumPriceByDatePay' , (req,res) => {
    ...
    router.post('/addBill', (req,res)=> {
      ...
      pool.query('INSERT INTO public."Bill"("datePay", status, array["idTable"], "foodID", "sumPrice")VALUES ($1,$2,$3,$4,$5);',[billObj.datePay,billObj.status,billObj.idTable,billObj.foodID,billObj.sumPrice], (err, data) => {
